...
export const validations: FormValidations = {
  ...
  sectionB: {
    ...
    Age: [{ type: 'min', message: 'Age must be at least 0' }, { type: 'max', message: 'Age cannot be more than 120' }]
  },
  sectionC: {},
  sectionD: {
    HeightCM: [
    ...
    PO2: [{ type: 'min', message: 'PO2 must be at least 40' }, { type: 'max', message: 'PO2 cannot be more than 500' }],
    WBC: [
  ...
  sectionJ: {
    NumIMADA: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 6' }],
    NumRadDA: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 6' }],
    RadHarvPrepTm: [
      { type: 'min', message: 'must be at least 0' },
      { type: 'max', message: 'cannot be more than 240' }
    ],
    DistVein: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 9' }],
    SaphHarPrepTm: [
      { type: 'min', message: 'must be at least 0' },
      { type: 'max', message: 'cannot be more than 240' }
    ],
    NumOArtD: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 6' }],
    NumArtVenComp: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 5' }],
    NumVenArtComp: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 5' }],
    NumArtArtComp: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 5' }]
  },
  sectionK: {
    VSAoImSz: [{ type: 'min', message: 'must be at least 5' }, { type: 'max', message: 'cannot be more than 100' }],
    VSMiImSz: [{ type: 'min', message: 'must be at least 5' }, { type: 'max', message: 'cannot be more than 100' }],
    VSTrImSz: [{ type: 'min', message: 'must be at least 5' }, { type: 'max', message: 'cannot be more than 100' }],
    VSPuImSz: [{ type: 'min', message: 'must be at least 5' }, { type: 'max', message: 'cannot be more than 100' }]
  },
  sectionL: {},
  sectionL2: {},
  sectionM: {},
  ...
  sectionM2: {
    ...
    Diam3DSinus: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DSinotubular: [
      { type: 'min', message: 'must be at least 10' },
      { type: 'max', message: 'cannot be more than 120' }
    ],
    ...
    Diam3DZone1: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone2: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone3: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone4: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone5: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone6: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone7: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone8: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone9: [{ type: 'min', message: 'must be at least 10' }, { type: 'max', message: 'cannot be more than 120' }],
    Diam3DZone10: [
      { type: 'min', message: 'must be at least 10' },
      { type: 'max', message: 'cannot be more than 120' }
    ],
  ...
  sectionO: {
    ...
    PostCreat: [{ type: 'min', message: 'must be at least 0.1' }, { type: 'max', message: 'cannot be more than 30.0' }],
    PostopHemoglobin: [
    ...
    ICUAdHrs: [{ type: 'min', message: 'must be at least 0.1' }, { type: 'max', message: 'cannot be more than 5000.0' }]
  },
  sectionP: {},
  sectionQ: {},
  sectionR: {},
  sectionS: {
    CellSavVol: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 10000' }],
    TotHep: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 200000' }],
    TotProt: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 1000' }],
    AntithromDose: [
      { type: 'min', message: 'must be at least 0' },
      { type: 'max', message: 'cannot be more than 7500' }
    ],
    MidazIntra: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 50' }],
    TotInsuIntra: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 200' }],
    PreAnesthBPSys: [
    ...
    PreAnesthHR: [{ type: 'min', message: 'must be at least 30' }, { type: 'max', message: 'cannot be more than 170' }],
    CoreTempMax: [
    ...
    PreLVEF: [{ type: 'min', message: 'must be at least 1.0' }, { type: 'max', message: 'cannot be more than 99.0' }],
    PreAVA: [{ type: 'min', message: 'must be at least 0.2' }, { type: 'max', message: 'cannot be more than 5.0' }],
    MxAscAo: [{ type: 'min', message: 'must be at least 1.0' }, { type: 'max', message: 'cannot be more than 8.0' }],
    MxAscAoThick: [
      { type: 'min', message: 'must be at least 0.0' },
      { type: 'max', message: 'cannot be more than 20.0' }
    ],
    MxArcAth: [{ type: 'min', message: 'must be at least 0.0' }, { type: 'max', message: 'cannot be more than 20.0' }],
    ...
    PostLVEF: [{ type: 'min', message: 'must be at least 1.0' }, { type: 'max', message: 'cannot be more than 99.0' }],

    PostCoreTemp: [
      { type: 'min', message: 'must be at least 30.0' },
      { type: 'max', message: 'cannot be more than 41.0' }
    ],
    PostINR: [{ type: 'min', message: 'must be at least 0.5' }, { type: 'max', message: 'cannot be more than 5.0' }],
    PostWBC: [
    ...
    PostHCT: [{ type: 'min', message: 'must be at least 10.0' }, { type: 'max', message: 'cannot be more than 60.0' }],
    PostFibrin: [
      { type: 'min', message: 'must be at least 0.0' },
      { type: 'max', message: 'cannot be more than 1,200.0' }
    ],
    PostLact: [{ type: 'min', message: 'must be at least 0' }, { type: 'max', message: 'cannot be more than 20' }]
  }
};
