...
export class CathPciReport {
  ...
  public async getDocDefinition(): Promise<pdfMake.TDocumentDefinitions> {
    const printedDateTime = this.printedDateTime;
    const printedBy = this.printedBy;
    ...
    const doc = {
      ...
      header(currentPage, pageCount, pageSize) {
        return [
          pdf.text(staffId ? staffId : '', { fontSize: 4, color: 'white' }),
          pdf.text(isoDate ? isoDate : '', { fontSize: 4, color: 'white' })
        ];
      },
      footer(currentPage, pageCount, pageSize) {
        return pdf.columns(
          pdf.blockStyle(
            { width: 255, margin: [40, 0, 0, 0] },
            pdf.text('BDMS CathPCI Registry v1.0', { alignment: 'left' }),
            pdf.text(' - last updated 11/12/2019', { italics: true, fontSize: 9 })
          ),
        ...
        pdf.stack(
          ...
          pdf.columns(
            pdf.block(
              ...
              pdf.tab(),
              pdf.radio('Arab', this.data ? this.data.sectionA.Race : null),
              pdf.tab(),
      ...
      [
        pdf.stack(
          ...
          pdf.block(
            ...
            pdf.inputThai(this.data ? this.data.sectionE.DCathProvider : null)
          ),
          pdf.block(
          ...
          pdf.block(
            ...
            '1ˢᵗ Operator - ',
            pdf.inputThai(this.data ? this.data.sectionE.PCIProvider : null),
            pdf.tab(4),
            '2ⁿᵈ Operator - ',
            pdf.inputThai(this.data ? this.data.sectionE.PCIProvider2 : null)
          ),
          pdf.block(
        ...
        pdf.stackStyle(
          ...
          pdf.columns(
            ...
            pdf.block(
              ...
              pdf.inputThai(this.data ? this.data.sectionL.DCProvider : null)
            )
          ),
          pdf.block(
  ...
  private async appendix(): Promise<pdfMake.Content[][]> {
    return [
      ...
      [
        pdf.stack(
          {
            image: await pdf.imageToBase64('assets/figures/coronary-artery-segment.png'),
            fit: [450, 450],
            alignment: 'center',
            margin: [0, 0, 0, 3]
          },
          ...
          pdf.columns(
            {
              image: await pdf.imageToBase64('assets/figures/csha-frailty-scale.png'),
              fit: [210, 400],
              alignment: 'center'
            },
            pdf.stack(
              ...
              {
                image: await pdf.imageToBase64('assets/figures/medina-classification.png'),
                fit: [200, 400],
                alignment: 'center'
              }
            )
