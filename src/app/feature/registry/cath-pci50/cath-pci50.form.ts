...
export const CathPci50Form = {
  ...
  nativeLesion: {
    ...
    NV_IVUS_Pre: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    NV_IVUS_Post: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    NV_OCT_Pre: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    NV_OCT_Post: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
  },
  graftLesion: {
    ...
    Graft_IVUS_Pre: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    Graft_IVUS_Post: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    Graft_OCT_Pre: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
    Graft_OCT_Post: [null, [Validators.required, Validators.min(0), Validators.max(10)]],
  },
  sectionI: {
