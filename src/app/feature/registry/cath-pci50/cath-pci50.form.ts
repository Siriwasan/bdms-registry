...
export const CathPci50Form = {
  ...
  followUp: {
    ...
    FU_ACEIRN: [null, Validators.required],
    FU_Warfarin: [null, Validators.required],
    FU_WarfarinRN: [null, Validators.required],
    FU_Aspirin: [null, Validators.required],
    FU_AspirinRN: [null, Validators.required],
    FU_Vorapaxar: [null, Validators.required],
    FU_VorapaxarRN: [null, Validators.required],
    FU_ARB: [null, Validators.required],
    FU_ARBRN: [null, Validators.required],
    FU_BetaBlocker: [null, Validators.required],
    FU_BetaBlockerRN: [null, Validators.required],
    FU_Apixaban: [null, Validators.required],
    FU_ApixabanRN: [null, Validators.required],
    FU_Dabigatran: [null, Validators.required],
    FU_DabigatranRN: [null, Validators.required],
    FU_Edoxaban: [null, Validators.required],
    FU_EdoxabanRN: [null, Validators.required],
    FU_Rivaroxaban: [null, Validators.required],
    FU_RivaroxabanRN: [null, Validators.required],
    FU_Clopidogrel: [null, Validators.required],
    FU_ClopidogrelRN: [null, Validators.required],
    FU_Prasugrel: [null, Validators.required],
    FU_PrasugrelRN: [null, Validators.required],
    FU_Ticagrelor: [null, Validators.required],
    FU_TicagrelorRN: [null, Validators.required],
    FU_Ticlopidine: [null, Validators.required],
    FU_TiclopidineRN: [null, Validators.required],
    FU_Statin: [null, Validators.required],
    FU_StatinDose: [null, Validators.required],
    FU_StatinRN: [null, Validators.required],
    FU_NonStatin: [null, Validators.required],
    FU_NonStatinRN: [null, Validators.required],
    FU_Alirocumab: [null, Validators.required],
    FU_AlirocumabRN: [null, Validators.required],
