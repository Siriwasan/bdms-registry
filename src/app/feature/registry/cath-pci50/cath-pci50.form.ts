...
export const CathPCI50Form = {
  ...
  sectionG: {
    ...
    ValvularDzStenosisType: [null, Validators.required],
    ValvularDzStenosisSev: [null, Validators.required],
    ValvularDzRegurgType: [null, Validators.required],
    RegurgSeverity: [null, Validators.required],
  ...
  sectionI: {
    ...
    ThromType: [null, Validators.required],
