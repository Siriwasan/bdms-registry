...
export const CathPci50Form = {
  ...
  nativeLesion: {
    ...
    NV_IVUS: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
  ...
  graftLesion: {
    ...
    Graft_IVUS: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
  ...
  pciLesion: {
    ...
    MB_IVUS_Pre: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
    MB_IVUS_Post: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
    ...
    SB_IVUS_Pre: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
    SB_IVUS_Post: [null, [Validators.required, Validators.min(0), Validators.max(20)]],
