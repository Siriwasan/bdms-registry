...
export const validations: FormValidations = {
  ...
  sectionB: {
    ArrivalDateTime: [
      ...
      },
      {
        ...
        message:
          'ED Presentation at Referring Facility DateTime should be before Arrival DateTime.',
      },
      {
  ...
  sectionE: {
    ...
    ProcedureStartDateTime: [
      ...
      },
      {
        ...
        message:
          'Hemorrhage Stroke Complication DateTime should be after Procedure Start DateTime.',
      },
      {
  ...
  nativeLesion: {
    ...
    NV_OCT: [
      ...
      { type: 'max', message: 'OCT cannot be more than 20.00 mm2.' },
    ],
  },
  graftLesion: {
